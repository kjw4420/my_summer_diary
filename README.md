...
<img width="918" alt="스크린샷 2023-07-17 오전 2 33 30" src="https://github.com/kjw4420/my_summer_diary/assets/97749184/dbea4fa4-09dc-424a-91de-bdeaf3792500"><br>
  ...
  짧은 여름방학/휴가 기간 동안 사용하는 다이어리 웹 페이지이다. 어린 시절 여름 방학 숙제였던 **그림일기**를 모티브로 하였으며, 어른이들에게 어린 시절의 추억을 떠올리게 한다. 여름방학때 밀려 쓰던 그런 일기 말고 스스로 하루 하루를 짧게 기록해보자!

## 📗 주요 기능
🔍**회원가입 및 로그인**<br>
해당 웹 페이지의 접근성과 간편성을 높이기 위해 최대한 회원가입 절차를 단순화 하여 꼭 필요한 닉네임, 비밀번호만 사용자로부터 받는다. 또 회원의 여름방학/휴가 기간을 받아 해당 기간동안만 **나의 여름방학 일기**를 사용한다.<br><br>
🔍**To Do List**<br>
매일 해야할 일의 체크리스트를 만들어 관리한다.<br><br>
🔍**Summer Vacation Bucket List**<br>
여름 방학 기간동안 하고 싶은 일들을 적어 관리한다.<br><br>
🔍**다이어리 쓰기**<br>
날짜, 날씨, 그림, 사진, 글을 기록하여 짧게 매일 일기를 쓴다.<br><br>
